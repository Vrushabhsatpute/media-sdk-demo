 ...
 */
export function useMediaSearch({ type, query, perPage = 20, debounceMs = 400 }) {
    ...
    const fetchPage = useCallback(async (targetPage, mode, key) => {
        ...
        try {
            ...
            if (requestId !== requestIdRef.current || key !== activeKeyRef.current)
                return;
            setItems((prev) => {
